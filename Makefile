...
SOURCES = \
	__init__.py \
	controles_ign.py controles_ign_dialog.py

PLUGINNAME = controles_ign

PY_FILES = \
	__init__.py \
	controles_ign.py controles_ign_dialog.py

UI_FILES = controles_ign_dialog_base.ui
...
QGISDIR=C:\Users\todarbellay\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
