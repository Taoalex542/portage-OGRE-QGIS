...
class recherche(QDockWidget):
    ...
    def search_update_couche_status(self, name, status):
        for items in self.main.temp_couche_list:
            if items[0] == name:
                items[1] = status
    ...
    def search_couche2(self, num_children, parent):
        for i in range(parent.childCount()):
            ...
            if num_children != 0:
                ...
                if [child.text(0), 0] not in self.main.temp_couche_list and [child.text(0), 2] not in self.main.temp_couche_list:
                    self.main.temp_couche_list.append([child.text(0), child.checkState(0)])
                else:
    ...
    def search_couche(self):
        ...
        for i in range(root.childCount()):
            ...
            if (num_children != 0):
                ...
                if [signal.text(0), 0] not in self.main.temp_couche_list and [signal.text(0), 2] not in self.main.temp_couche_list:
                    self.main.temp_couche_list.append([signal.text(0), signal.checkState(0)])
                else:
    ...
    def search_update_status(self, name, status):
        for items in self.main.temp_ctrl_list:
            if items[0] == name:
                items[1] = status
    ...
    def search_control2(self, num_children, parent):
        for i in range(parent.childCount()):
            ...
            if num_children != 0:
                ...
                if [child.text(0), 0] not in self.main.temp_ctrl_list and [child.text(0), 2] not in self.main.temp_ctrl_list:
                    self.main.temp_ctrl_list.append([child.text(0), child.checkState(0)])
                else:
    ...
    def search_control(self):
        ...
        for i in range(root.childCount()):
            ...
            if (num_children != 0):
                ...
                if [signal.text(0), 0] not in self.main.temp_ctrl_list and [signal.text(0), 2] not in self.main.temp_ctrl_list:
                    self.main.temp_ctrl_list.append([signal.text(0), signal.checkState(0)])
                else:
